...
class HybridRetriever:
    def __init__(self, embeddings_dir: str):
        ...
        self.file_index = faiss.read_index(os.path.join(embeddings_dir, "file_summary.index"))
        with open(os.path.join(embeddings_dir, "file_summary_ids.json"), "r", encoding="utf-8") as f:
            self.file_ids = json.load(f)
        self.symbol_index = faiss.read_index(os.path.join(embeddings_dir, "symbol_summary.index"))
        with open(os.path.join(embeddings_dir, "symbol_summary_ids.json"), "r", encoding="utf-8") as f:
